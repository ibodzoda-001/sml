...
import {Button, Card, Divider, Empty, Image, List} from "antd";
                            ...
                            <>
                                {
                                    listType === 'list'
                                        ? <List
                                            ...
                                            size="large"
                                            pagination={null}
                                            dataSource={listOfAds}
                                            renderItem={(item, itemIndex) => (
                                                <Card style={{marginTop: '15px'}} className="card-shadow">
                                                    <List.Item
                                                        onClick={() => {
                                                            history.push(`/ad/${purpose}/${item.id}`);
                                                        }}
                                                        key={itemIndex}
                                                        actions={[
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <p style={{fontSize: '17px'}}>{item.content}</p>
                                                    </List.Item>
                                                </Card>
                                            )}
                                        />
                                        : <div>
                                            {listOfAds.map((ad, adIndex) => {
                                                return (<Card
                                                    ...
                                                    cover={ad.pictures.length !== 0
                                                        ? <img alt="example" style={{objectFit: 'contain', height: '200px'}}
                                                               src={ad.pictures[0].link}/>
                                                        : <Image
                                                            style={{height: '200px'}}
                                                            src="error"
                                                            fallback="data:image/png;base64,"
                                                        />}>
                                                    <Meta title={(<div style={{textAlign: 'end'}}>
                                        <span style={{
                                            fontSize: '20px',
                                            color: 'dimgray'
                                        }}>
                                        {ad.price} TJS{ad.bargain ? '. Торг.' : ''}
                                    </span>
                                                    </div>)}/>
